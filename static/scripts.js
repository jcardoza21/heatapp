...
function example1(mecanismo)
{
    if (mecanismo == conduccion)
    {
        ...
        <ol>
        <li>La mayor parte de la conducción ocurre en la superficie de la Tierra.
        Durante el día, la radiación solar calienta el suelo y el agua, que luego calientan el aire que los toca.
        El aire no es un buen conductor de energía térmica porque las partículas de los gases que componen la atmósfera están muy separadas.
        </li>
        </ol>
        ;
